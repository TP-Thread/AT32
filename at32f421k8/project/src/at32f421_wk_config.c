...
void wk_gpio_config(void)
{
  ...
  /* gpio output config */
  gpio_bits_reset(GPIOB, GPIO_PINS_0 | GPIO_PINS_3);
...
void wk_adc1_init(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_7, 2, ADC_SAMPLETIME_1_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_4, 3, ADC_SAMPLETIME_1_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_1, 4, ADC_SAMPLETIME_1_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_6, 5, ADC_SAMPLETIME_1_5);
